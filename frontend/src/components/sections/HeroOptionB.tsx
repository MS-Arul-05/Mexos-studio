...
/**
 * OPTION B: Editorial Frame
 * - Image placed inside a styled rounded container with subtle shadow
 * - Looks like a magazine photo placement — intentional, polished
 */
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 28px", position: "relative" }}>
        ...
        >
          ...
          <div className="hero-left">
            <div className="hero-fade hero-fade-1" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 16px", borderRadius: 50, backgroundColor: "rgba(246,180,154,0.08)", border: "1px solid rgba(246,180,154,0.18)", marginBottom: 24 }}>
          ...
          {/* RIGHT SIDE — Option B: Editorial rounded frame */}
          <div
          ...
          >
            <div
              ...
              style={{
                ...
                borderRadius: 24,
                overflow: "hidden",
                boxShadow: "0 20px 60px rgba(0,0,0,0.08), 0 4px 16px rgba(233,152,122,0.1)",
      ...
      <style jsx global>{`
        ...
        .hero-image:hover { transform: translateY(-8px) !important; box-shadow: 0 28px 70px rgba(0,0,0,0.1), 0 6px 20px rgba(233,152,122,0.15) !important; }
        @media (max-width: 1024px) {
          ...
          .hero-right .hero-image { width: 100% !important; }
